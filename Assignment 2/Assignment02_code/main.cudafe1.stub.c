...
static void __nv_cudaEntityRegisterCallback( void **__T32) {  __nv_dummy_param_ref(__T32); __nv_save_fatbinhandle_for_managed_rt(__T32); __cudaRegisterEntry(__T32, ((void ( *)(const unsigned char *, const float *, unsigned char *, int, int, int, int, int))gpu1), _Z4gpu1PKhPKfPhiiiii, (-1)); }
